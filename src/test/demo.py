...
# from model.diss import BiSeNet
import os
import torch
import cv2
...
if __name__ == '__main__':
    params = [
        '--image',
        '--data', '/data/detect/zz1.jpg',
        '--checkpoint_path', '/data/models/img_seg/best_dice_loss_miou_0.655.pth',
        '--cuda', '0',
        '--csv_path', '/data/detect/CamVid/class_dict.csv',
        '--save_path', 'demo4.png',
        '--context_path', 'resnet18'
    ]
    # main(params)
    #best_dice_loss_miou_0.655.pth
    get_label_img('/data/detect/CamVid/class_dict.csv')