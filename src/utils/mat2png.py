...
if __name__ == '__main__':
    ...
    # p = '/data/detect/VOC/VOCdevkit/VOC2010/Seglabels22/2008_003140.png'
    # img = cv2.imread(p)
    # print(img.shape)
    # cv2.imshow('src',img)
    # cv2.waitKey(0)
    # mat2png()
    sel2label('/data/detect/VOC/VOCdevkit/VOC2010/Seglabels22','/data/detect/VOC/VOCdevkit/VOC2010/JPEGImages','/data/detect/VOC/VOCdevkit/VOC2010/label22')
