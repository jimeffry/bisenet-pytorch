...
from bs_resnet import resnet101,resnet18
import warnings
...
class BiSeNet(torch.nn.Module):
    def __init__(self, num_classes, context_path):
        ...
        # build context path
        self.context_path = resnet101(pretrained=False)  #build_contextpath(name=context_path)
    ...
    def forward(self, input):
        ...
        cx1 = torch.nn.functional.interpolate(cx1, size=sx.size()[-2:], mode='nearest')
        cx2 = torch.nn.functional.interpolate(cx2, size=sx.size()[-2:], mode='nearest')
