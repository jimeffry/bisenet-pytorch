...
class ContextPath(nn.Module):
    def __init__(self, *args, **kwargs):
        ...
        self.conv_avg = ConvBNReLU(2048, 128, ks=1, stride=1, padding=0) #512 2048
...
class BiSeNet(nn.Module):
    def __init__(self, n_classes, *args, **kwargs):
        ...
        self.ffm = FeatureFusionModule(640, 256) #res18-256,res101-640
        self.conv_out = BiSeNetOutput(256, 256, n_classes)
        self.conv_out16 = BiSeNetOutput(128, 64, n_classes)
        self.conv_out32 = BiSeNetOutput(128, 64, n_classes)
        self.conv_last = nn.Conv2d(in_channels=n_classes, out_channels=n_classes, kernel_size=1)
        self.init_weight()
    ...
    def forward(self, x):
        ...
        feat_out = self.conv_last(feat_out)
